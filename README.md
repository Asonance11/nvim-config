...
```sh
git clone https://github.com/Asonance11/nvim-config.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/Asonance11/nvim-config.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/Asonance11/nvim-config.git "${env:LOCALAPPDATA}\nvim"
```
